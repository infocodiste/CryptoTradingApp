      ...
      body: new ListView(
        children: <Widget>[
          ...
          new Container(
            ...
            child: new ListTile(
              leading: new Image(
                  image: AssetImage("assets/icons/network.png"),
          ...
          new Container(
            padding: const EdgeInsets.all(10.0),
            child: new Text("Debug", style: Theme.of(context).textTheme.bodyText2),
          ),
          // new Container(
          //   color: Theme.of(context).cardColor,
          //   child: new ListTile(
          ...
          new Container(
            padding: const EdgeInsets.all(10.0),
            child: new Text("Credit", style: Theme.of(context).textTheme.bodyText2),
          ),
          new Container(
            color: Theme.of(context).cardColor,
            child: new ListTile(
              ...
              subtitle: new Text("twitter.com/infocodistecom2"),
              leading: new Icon(Icons.favorite),
              onTap: () => _launchUrl("https://twitter.com/infocodistecom2"),
            ),
          ),
        ],
      ),
