...
class CovalentTokenListResponse {
  Data data;
  bool error;
  Null errorMessage;
  Null errorCode;

  CovalentTokenListResponse(
      {this.data, this.error, this.errorMessage, this.errorCode});

  CovalentTokenListResponse.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['items'] != null) {
      items = new List<CovalentToken>();
      json['items'].forEach((v) {
        items.add(new CovalentToken.fromJson(v));
      });
    }
...
class CovalentToken {
  ...
  CovalentToken.fromJson(Map<String, dynamic> json) {
    contractDecimals =
