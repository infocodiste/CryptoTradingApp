...
class NetworkConfig {
  static final TestnetConfig = {
    ...
    transakLink: "https://staging-global.transak.com?apiKey="
        // "176a6690-e87c-4c10-ad40-cfc5e1a70599"
        "c8b2b6e7-40c0-4696-b7a1-5fb60073b5a1"
        "&cryptoCurrencyCode=BNB"
        "&defaultNetwork=bsc"
        // "&hideMenu=true"
        // "&themeColor=${AppTheme.primaryHex}"
        "&walletAddress=",
  ...
  static const MainnetConfig = {
    ethEndpoint:
        "https://mainnet.infura.io/v3/06a5e776d8cd4560b8d88f5b82d7c51d",
    ethChainId: 1,
    endpoint: "https://bscscan.com",
    chainId: 137,
    ...
    ethWebsocket:
        "wss://mainnet.infura.io/ws/v3/06a5e776d8cd4560b8d88f5b82d7c51d",
    rootChainProxy: "0xA0c68C638235ee32657e8f720a23ceC1bFc77C77",
    //proxy
